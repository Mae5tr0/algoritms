...
//        drawLineNode(node, even, minX, maxX, minY, maxY);
    ...
    private void drawLineNode(Node node, boolean even, double minX, double maxX, double minY, double maxY) {
...
//        RectHV rect = new RectHV(0.0, 0.0, 0.372, 0.497);
//        rect.draw();
//
//        StdDraw.setPenColor(StdDraw.RED);
//        for (Point2D interseptionPoint : tree.range(rect)) {
